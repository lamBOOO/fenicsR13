...
// This variant flips the diagonals relative to structured_simple_mesh.geo.
//
// Domain: (0, 8)^2 \ [1, 3]^2
...
Transfinite Surface{4005} Left;
Transfinite Surface{4006} Left;
Transfinite Surface{4007} Left;
Transfinite Surface{4008} Left;
