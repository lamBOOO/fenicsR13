...
res_tmp1 = 2^-split * 2^-exp1; // leftbot edge
res_tmp2 = 2^-split * 2^-exp2; // bulk
res_tmp3 = 2^-split * 2^-exp3; // topright edge
res_tmp4 = 2^-split * 2^-exp4; // leftbot focus
res_tmp5 = 2^-split * 2^-exp5; // inner edge focus
res_tmp6 = 2^-split * 2^-exp6; // inner edge
res_tmp7 = 2^-split * 2^-exp7; // focus bulk
