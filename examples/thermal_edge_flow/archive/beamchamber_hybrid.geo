...
Line(2301) = {1301, 1302}; Transfinite Line {2301} = 2.0*rho1;
Line(2302) = {1302, 1303}; Transfinite Line {2302} = 2.0*rho1;
Line(2303) = {1303, 1304}; Transfinite Line {2303} = 2.0*rho1;
Line(2304) = {1304, 1301}; Transfinite Line {2304} = 2.0*rho1;
...
Curve Loop(3201) = {2101, 2102, 2103, 2104};
Curve Loop(3202) = {2202, 2203, 2204, 2205, 2206, 2207, 2208, 2209, 2210, 2211, 2212, 2201};
Plane Surface(4201) = {3201, 3202};
