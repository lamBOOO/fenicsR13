...
Circle(2601) = {1212, 1301, 1202}; // Transfinite Line {2601} = rho2 * Pi * 2 * (dist2/2) / 4;
Circle(2602) = {1203, 1302, 1205}; // Transfinite Line {2602} = rho2 * Pi * 2 * (dist2/2) / 4;
Circle(2603) = {1206, 1303, 1208}; // Transfinite Line {2603} = rho2 * Pi * 2 * (dist2/2) / 4;
Circle(2604) = {1209, 1304, 1211}; // Transfinite Line {2604} = rho2 * Pi * 2 * (dist2/2) / 4;
