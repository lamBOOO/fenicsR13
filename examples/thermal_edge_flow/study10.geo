...
res2 = 2^-split * 2^-3; // bulk
res3 = 2^-split * 2^-4; // topright edge
res4 = 2^-split * 2^-7; // leftbot focus
res5 = 2^-split * 2^-exp5; // inner edge focus
res6 = 2^-split * 2^-7; // inner edge
res7 = 2^-split * 2^-4; // focus bulk
...
Point(1302) = {1.0+dist2, 1.0, 0, res6};
Point(1303) = {3.0-dist2, 1.0, 0, res6};
...
Point(1311) = {1.0, 3.0-dist2, 0, res6};
Point(1312) = {1.0, 1.0+dist2, 0, res6};
