...
class Temperature : public dolfin::Expression {
    ...
    void eval(Eigen::Ref<Eigen::VectorXd> values,
        ...
        // double theta = -(std::pow(-1 + x[0],2)*std::pow(x[0],2)*std::pow(-1 + x[1],2)*std::pow(x[1],2));

        values[0] = -(std::pow(-1 + x[0],2)*std::pow(x[0],2)*std::pow(-1 + \
x[1],2)*std::pow(x[1],2));
    }
};
...
x[1],2)*std::pow(x[1],2);
        values[1] = std::pow(-1 + \
x[0],2)*std::pow(x[0],2)*std::pow(-1 + x[1],2)*std::pow(x[1],2);
    }
};
...
class Pressure : public dolfin::Expression {
    ...
    void eval(Eigen::Ref<Eigen::VectorXd> values,
        ...
        // values[0] = 0.0011111111111111111 - std::pow(-1 + x[0],2)*std::pow(x[0],2)*std::pow(-1 + x[1],2)*std::pow(x[1],2);
        // values[0] = std::sin(2*boost::math::float_constants::pi*x[0])*std::sin(2*boost::math::float_constants::pi*x[1]);
    }
};
...
class Velocity : public dolfin::Expression {
    ...
    void eval(Eigen::Ref<Eigen::VectorXd> values,
        ...
        values[0] = 2*std::pow(-1 + x[0],2)*std::pow(x[0],2)*std::pow(-1 + x[1],2)*x[1] + \
2*std::pow(-1 + x[0],2)*std::pow(x[0],2)*(-1 + x[1])*std::pow(x[1],2);
        values[1] = -2*std::pow(-1 + x[0],2)*x[0]*std::pow(-1 + x[1],2)*std::pow(x[1],2) \
- 2*(-1 + x[0])*std::pow(x[0],2)*std::pow(-1 + \
x[1],2)*std::pow(x[1],2);
    }
};
...
x[0],2)*std::pow(x[0],2)*std::pow(-1 + x[1],2)*std::pow(x[1],2);
        values[2] = std::pow(-1 + \
x[0],2)*std::pow(x[0],2)*std::pow(-1 + x[1],2)*std::pow(x[1],2);
        values[3] = std::pow(-1 + x[0],2)*std::pow(x[0],2)*std::pow(-1 + \
x[1],2)*std::pow(x[1],2);
    }
};
